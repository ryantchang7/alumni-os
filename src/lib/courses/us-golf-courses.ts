...
export const US_GOLF_COURSES: GolfCourse[] = [
  ...
  // Ultra-private / new elite (FL coast + others)
  { name: 'Apogee Club', state: 'FL' },
  { name: 'Driftwood Golf Club', state: 'FL' },
  { name: 'Adios Golf Club', state: 'FL' },
  { name: 'Panther National', state: 'FL' },
  { name: 'Atlantic Fields', state: 'FL' },
  { name: 'Banyan Cay Resort & Golf', state: 'FL' },
  { name: 'Trump International Golf Club West Palm Beach', state: 'FL' },
  { name: 'Lost Lake Club', state: 'FL' },
  { name: 'Hammock Dunes Club', state: 'FL' },
  { name: 'Cypress Links', state: 'FL' },
  { name: 'Cabot Citrus Farms', state: 'FL' },
  { name: 'Diamond Creek Golf Club', state: 'NC' },
  { name: 'The Cliffs at Walnut Cove', state: 'NC' },
  { name: 'The Cliffs at Mountain Park', state: 'SC' },
  { name: 'Cabot Cliffs (US)', state: 'NC' },
  { name: 'Old Macdonald (Bandon)', state: 'OR' },
  { name: 'GallowayNJ National Golf Club', state: 'NJ' },
