      ...
      <div className="max-w-[1320px] mx-auto px-8 py-10">
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-5 mb-8">
          ...
          <p className="text-sm text-amber-700 leading-relaxed">
            This screen was a demo simulation of the AI pipeline agent. It has been replaced by the
            real workflow in the Builder.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link
            ...
            style={{ boxShadow: '0 1px 3px rgba(10,22,40,0.06), 0 4px 12px rgba(10,22,40,0.04)' }}
          >
            <p className="text-sm font-semibold text-[#0a1628] mb-1">Historical Import</p>
          ...
          <Link
            ...
            style={{ boxShadow: '0 1px 3px rgba(10,22,40,0.06), 0 4px 12px rgba(10,22,40,0.04)' }}
          >
            <p className="text-sm font-semibold text-[#0a1628] mb-1">Roster Extractor</p>
