...
export default function NewTeamPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.push('/teams/penn-mens-golf/agent')
  }

  return (
    <div className="min-h-screen bg-[#f8f5f0] flex flex-col">
      {/* Navy top strip */}
      <div className="bg-[#0a1628] py-10 px-6">
        <div className="max-w-xl mx-auto text-center">
          <h1 className="text-white text-2xl font-semibold mb-2">Build Your Alumni Graph</h1>
      ...
      <div className="flex-1 flex items-start justify-center px-6 py-10">
        <div className="w-full max-w-xl bg-white border border-gray-100 rounded-xl shadow-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-2">
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-[#990000] hover:bg-[#cc0000] text-white font-semibold py-3 h-auto text-sm transition-colors"
              >
                {loading ? (
