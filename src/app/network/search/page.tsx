...
function NetworkSearchInner() {
  ...
  useEffect(() => {
    fetch(`/api/network/profiles?teamSlug=${teamSlug}`)
      .then(r => {
          ...
          <>
            ...
            {filtered.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-base font-semibold text-[#0a1628] mb-1">No alumni match your search</p>
                <button
                    ...
                    >
                      ...
                      <div className="space-y-0.5 mb-3">
                        {profile.rosterYearsLabel !== '—' && (
                          <p className="text-xs text-[#8a7f70]">Penn Golf {profile.rosterYearsLabel}</p>
                        )}
                        {profile.classLabel && (
