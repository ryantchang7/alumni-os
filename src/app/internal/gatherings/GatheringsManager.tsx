    ...
    <div className="bg-white border border-[rgba(180,168,150,0.35)] rounded-xl p-4"
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="text-right flex-shrink-0">
          ...
          <p className="text-[11px] text-ink-muted">requests</p>
        </div>
      </div>
    </div>
  )
...
export default function GatheringsManager() {
  ...
  const inputCls = 'text-sm text-[#0a1628] placeholder-[#b5ad9e] bg-[#fbf9f6] border border-[rgba(180,168,150,0.5)] rounded-lg px-3 py-2 focus:outline-none focus:border-[#0a1628] transition-colors w-full'
  const selectCls = 'text-sm text-[#0a1628] bg-[#fbf9f6] border border-[rgba(180,168,150,0.5)] rounded-lg px-3 py-2 focus:outline-none focus:border-[#0a1628] transition-colors w-full'
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-ink-muted mt-0.5">{gatherings.length} active</p>
        </div>
        <button
          type="button"
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[rgba(180,168,150,0.35)] rounded-xl p-8 text-center"
          style={{ boxShadow: '0 1px 3px rgba(10,22,40,0.06)' }}>
          <p className="text-sm text-ink-muted">No gatherings yet. Create one above.</p>
        </div>
      ) : (
