    ...
    <div className="min-h-screen bg-[#fbf9f6]">
      <div className="bg-[#0a1628] px-8 pt-10 pb-14">
        <div className="max-w-[1320px] mx-auto">
          ...
          <h1 className="text-white text-2xl font-semibold tracking-tight">Gatherings</h1>
          <p className="text-gray-400 text-sm mt-2">
            Manage rounds, coffees, drinks, dinners, and events that appear on The Course, 19th Hole, and Events pages.
          </p>
        </div>
      </div>
